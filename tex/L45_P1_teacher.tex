...
This is a single-period quick treatment of Lesson 4-5. TWO examples are modeled in Launch (deviation from standard one-example rule --- solving AND extraneous checking are both assessment-critical). Release promptly at minute 18.\\
