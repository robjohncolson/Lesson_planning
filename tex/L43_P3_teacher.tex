...
\bankitem{Example 2 --- Simplify \((4-x^2)/(x^2+3x-10)\) (4-3-savvas-example-2-lesson-4-3)}{%
...
\bankitem{Example 6 --- SA/V Modeling (prism vs. cylinder) (4-3-savvas-example-6-lesson-4-3)}{%
...
\bankitem{Try It 6 (4-3-savvas-try-it-6-lesson-4-3)}{%
