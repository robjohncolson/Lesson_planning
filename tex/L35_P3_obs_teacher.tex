...
\textbf{Materials:} L35\_P3\_obs student packet, projected ``Mystery Graph'' slide, sentence-frame card, Desmos available for the share-out. \\
\hline
\end{tabularx}
...
\hline
\textbf{Date:} 5/8/26 & \textbf{Grade Level:} 11 & \textbf{Subject:} Algebra 2 -- Lesson 3-5, Day 3 / Period 3 Observation (Multiplicity + Factored-Form Graphing) \\
\hline
\end{tabularx}
...
\noindent
\begin{xltabular}{\textwidth}{|p{1.15in}|p{2.1in}|p{1.6in}|p{0.95in}|}
\hline
...
% ROW 4: Share/Summary
\textbf{Share/\allowbreak Summary (5 min)}
\begin{itemize}[label=$\bullet$, leftmargin=*, nosep]
    \item Synthesis
