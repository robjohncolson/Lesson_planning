...
\newenvironment{example}[1]{\textbf{Example #1}}{\vspace{1em}}
\newenvironment{tryit}[1]{\textbf{Try It! #1}}{\vspace{1em}}
...
\textbf{Vocabulary:} simplified form of a rational expression
\end{lesson-meta}
...
\addplot[domain=-15:10, color=red, thick, samples=2] {x + 2};
\node at (axis cs: 5, 7) [anchor=south west, color=red] {$y=x+2$};
\addplot[color=red, mark=*, fill=white, only marks, thick] coordinates {(-5, -3)};
\end{axis}
\end{tikzpicture}
...
Common factors divide to 1, so $\frac{-(x-2)(x+2)}{(x-2)(x+5)} = \frac{-(x-2)}{(x-2)} \cdot \frac{(x+2)}{(x+5)} = -1 \cdot \frac{(x+2)}{(x+5)}$.
...
\textbf{a.} $\frac{x^2 + 2x + 1}{x^3 - 2x^2 - 3x}$ \qquad
\textbf{b.} $\frac{x^3 + 4x^2 - x - 4}{x^2 + 3x - 4}$
\answer{}
\end{tryit}
...
$$ = \frac{2 \cdot 3 \cdot y \cdot x^3}{2 \cdot 2 \cdot y \cdot z^2} $$
...
\textbf{a.} $\frac{x^2-16}{9-x} \cdot \frac{x^2+x-90}{x^2+14x+40}$ \qquad
\textbf{b.} $\frac{x+3}{4x} \cdot \frac{3x-18}{6x+18} \cdot \frac{x^2}{4x+12}$
\answer{}
\end{tryit}
...
\textbf{a.} $\frac{x^3-4x}{6x^2-13x-5} \cdot (2x^3 - 3x^2 - 5x)$ \qquad
\textbf{b.} $\frac{3x^2+6x}{x^2-49} \cdot (x^2+9x+14)$
\answer{}
\end{tryit}
...
Multiply by the reciprocal of the divisor. The domain is $x \neq -4, -1, \text{ or } 1$.
...
\textbf{a.} $\frac{1}{x^2+9x} \div \left( \frac{6-x}{3x^2-18x} \right)$ \qquad
\textbf{b.} $\frac{2x^2-12x}{x+5} \div \left( \frac{x-6}{x+5} \right)$
\answer{}
\end{tryit}
...
\placeholder{diagram}{Option 1: 3D drawing of a rectangular prism with a square base, labeled with height 2x and base edges 2x and 2x.}
...
\placeholder{diagram}{Option 2: 3D drawing of a cylinder labeled with height 2x and base radius x.}
...
\begin{practice}{1}{\uncertain{?}{missing DOK}}
\textbf{ESSENTIAL QUESTION} How does multiplying and dividing fractions help you multiply and divide rational expressions?
\answer{}
\end{practice}

\begin{practice}{2}{\uncertain{?}{missing DOK}}
\textbf{Vocabulary} In your own words, define \textit{rational expression} and provide an example of a rational expression.
\answer{}
\end{practice}

\begin{practice}{3}{\uncertain{?}{missing DOK}}
\textbf{Error Analysis} A student divided the rational expressions as follows:
$$ \frac{4x}{5y} \div \frac{20x^2}{25y^2} = \frac{4x}{5y} \cdot \frac{4x^2}{5y^2} = \frac{16x^3}{25y^3} $$
Describe and correct the errors the student made.
\answer{}
\end{practice}

\begin{practice}{4}{\uncertain{?}{missing DOK}}
...
\begin{practice}{5}{\uncertain{?}{missing DOK}}
...
\begin{practice}{6}{\uncertain{?}{missing DOK}}
$\frac{4x^2y^2}{3z} \cdot \frac{15z^2}{20xy^3}$
\answer{}
\end{practice}

\begin{practice}{7}{\uncertain{?}{missing DOK}}
$\frac{y+3}{y+2} \cdot \frac{y^2+4y+4}{y^2-9}$
\answer{}
\end{practice}

\begin{practice}{8}{\uncertain{?}{missing DOK}}
...
\begin{practice}{9}{\uncertain{?}{missing DOK}}
$\frac{x^3+14x^2+49x}{x^2+3x-28} \div (x+7)$
\answer{}
\end{practice}

\begin{practice}{10}{\uncertain{?}{missing DOK}}
...
\begin{practice}{11}{\uncertain{?}{missing DOK}}
...
\begin{practice}{12}{\uncertain{?}{missing DOK}}
...
\begin{practice}{15}{\uncertain{?}{missing DOK}}
\textbf{Generalize} Explain the similarities between rational numbers and rational expressions.
\answer{}
\end{practice}

\begin{practice}{16}{\uncertain{?}{missing DOK}}
\textbf{Use Structure} Determine whether $\frac{5x+11}{6x+11} = \frac{5}{6}$ is \textit{sometimes, always,} or \textit{never} true. Justify your reasoning.
\answer{}
\end{practice}

\begin{practice}{17}{\uncertain{?}{missing DOK}}
\textbf{Construct Arguments} Explain how you can tell whether a rational expression is in simplest form.
\answer{}
\end{practice}

\begin{practice}{18}{\uncertain{?}{missing DOK}}
\textbf{Communicate Precisely} When multiplying $\frac{15}{x} \cdot \frac{x}{3} = 5$, is it necessary to make the restriction $x \neq 0$? Why or why not?
\answer{}
\end{practice}

\begin{practice}{19}{\uncertain{?}{missing DOK}}
...
\begin{practice}{20}{\uncertain{?}{missing DOK}}
$\frac{x(x-2)}{(x-5)}$ for all $x$ except $5$ and $-6$
\answer{}
\end{practice}

\begin{practice}{21}{\uncertain{?}{missing DOK}}
...
\begin{practice}{22}{\uncertain{?}{missing DOK}}
$\frac{y^2-5y-24}{y^2+3y}$
\answer{}
\end{practice}

\begin{practice}{23}{\uncertain{?}{missing DOK}}
$\frac{ab^3-9ab}{12ab^2+12ab-144a}$
\answer{}
\end{practice}

\begin{practice}{24}{\uncertain{?}{missing DOK}}
$\frac{x^2+8x+15}{x^2-x-12}$
\answer{}
\end{practice}

\begin{practice}{25}{\uncertain{?}{missing DOK}}
...
\begin{practice}{26}{\uncertain{?}{missing DOK}}
$\frac{x^2+6x+8}{x^2+4x+3} \cdot \frac{x+3}{x+2}$
\answer{}
\end{practice}

\begin{practice}{27}{\uncertain{?}{missing DOK}}
...
\begin{practice}{28}{\uncertain{?}{missing DOK}}
$\frac{(x+5)}{(x^3-25x)} \cdot (2x^3-11x^2+5x)$
\answer{}
\end{practice}

\begin{practice}{29}{\uncertain{?}{missing DOK}}
...
\begin{practice}{30}{\uncertain{?}{missing DOK}}
$\frac{y^2-16}{y^2-10y+25} \div \frac{3y-12}{y^2-3y-10}$
\answer{}
\end{practice}

\begin{practice}{31}{\uncertain{?}{missing DOK}}
$\frac{(x-y)^2}{x+y} \div \frac{3x+3y}{x^2-y^2}$
\answer{}
\end{practice}

\begin{practice}{32}{\uncertain{?}{missing DOK}}
$\frac{25x^2-4}{x^2-9} \div \frac{5x-2}{x+3}$
\answer{}
\end{practice}

\begin{practice}{33}{\uncertain{?}{missing DOK}}
$\frac{x^4+x^3-30x^2}{x^2-3x-18} \div \frac{x^3+x^2-30x}{x^2-36}$
\answer{}
\end{practice}

\begin{practice}{34}{\uncertain{?}{missing DOK}}
Find and simplify the ratio of the volume of Figure A to the volume of Figure B.
\placeholder{diagram}{Figure A is a rectangular prism with dimensions 3x, x, and x+1. Figure B is a rectangular prism with dimensions x+2, x, and 2x.}
\answer{}
\end{practice}

\textbf{APPLY}

\begin{practice}{35}{\uncertain{?}{missing DOK}}
...
\placeholder{diagram}{Cylinder A with radius 2r and height r. Cylinder B with radius r and height 3r.}
...
\begin{practice}{36}{\uncertain{?}{missing DOK}}
...
\placeholder{illustration}{A rectangular game board with width 3x and height x+1. Inside it is a smaller black rectangle with width x and height 1/2 x.}
\answer{}
\end{practice}

\begin{practice}{37}{\uncertain{?}{missing DOK}}
...
\begin{tikzpicture}
\draw[thick] (0,0) -- (4,0) -- (5,2.5) -- (1,2.5) -- cycle;
\draw[dashed, thick] (1,2.5) -- (1,0);
\node at (1.1, 1.25) [right] {$\frac{x+4}{2x+5}$};
\end{tikzpicture}
\answer{}
\end{practice}
...
\begin{practice}{38}{\uncertain{?}{missing DOK}}
...
\begin{itemize}
    ...
    \item[$\square$] $\frac{\frac{1}{y}}{y+3}$
\end{itemize}
\answer{}
\end{practice}

\begin{practice}{39}{\uncertain{?}{missing DOK}}
...
\begin{practice}{40}{\uncertain{?}{missing DOK}}
